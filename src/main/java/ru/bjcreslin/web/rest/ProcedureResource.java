...
/**
 * REST controller for managing {@link ru.bjcreslin.domain.Procedure}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ProcedureResource {
    ...
    public ResponseEntity<Procedure> createProcedure(@RequestBody Procedure procedure) throws URISyntaxException {
    ...
    public ResponseEntity<Procedure> updateProcedure(@RequestBody Procedure procedure) throws URISyntaxException {
